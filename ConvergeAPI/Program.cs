...
// Set the EPPlus LicenseContext to NonCommercial (free for non-commercial use)
...
builder.Services.AddScoped<DisabledWelfareFormService>();
builder.Services.AddScoped<DisabledWelfareFormRepository>();
